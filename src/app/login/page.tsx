  ...
  return (
    <div className={`relative flex items-center justify-center min-h-screen p-6 sm:p-10 lg:p-16 ${bgColor} ${textColor} transition-colors duration-300 font-sans`}>
      ...
      <div className="relative z-10 w-full flex justify-center">
        ...
        <div className={`w-full max-w-[440px] p-6 sm:p-10 rounded-3xl shadow-md bg-[#050508] border border-white/10 transition-all duration-300 flex flex-col justify-between`}>
