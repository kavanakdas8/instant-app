              ...
              {userDMs.map((chat) => {
                ...
                return (
                  <div
                    ...
                    className="glass p-4 rounded-2xl border border-zinc-900 hover:border-zinc-850 cursor-pointer transition-all flex items-center justify-between group animate-fade-in-up"
                  >
